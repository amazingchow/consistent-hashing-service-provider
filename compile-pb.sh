...
cd ${GOMODULEPATH}
for i in $(ls ${GOMODULEPATH}/github.com/amazingchow/photon-dance-consistent-hashing/pb/*.proto); do
	fn=github.com/amazingchow/photon-dance-consistent-hashing/pb/$(basename "$i")
	echo "compile" $fn
